    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="flex items-center bg-blue-200 p-4 rounded-md">
          ...
          <div className="ml-3">
            <p className="text-lg font-semibold text-blue-800">Total Projects</p>
            <p className="text-gray-600">{totalProjects} Projects</p>
          </div>
        </div>
        ...
        <div className="flex items-center bg-green-200 p-4 rounded-md">
          ...
          <div className="ml-3">
            <p className="text-lg font-semibold text-green-800">Active Projects</p>
            <p className="text-gray-600">{activeProjects} Active Projects</p>
          </div>
        </div>
        ...
        <div className="flex items-center bg-yellow-200 p-4 rounded-md">
          ...
          <div className="ml-3">
            <p className="text-lg font-semibold text-yellow-800">Completed Projects</p>
            <p className="text-gray-600">{completedProjects} Completed Projects</p>
          </div>
        </div>
      </div>
    </div>
